...
PROJECT_NAME := provider-jet-cloudamqp
PROJECT_REPO := github.com/timgchile/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/cloudamqp/terraform-provider-cloudamqp/releases/download/v1.15.1
...
IMAGES = provider-jet-cloudamqp provider-jet-cloudamqp-controller
