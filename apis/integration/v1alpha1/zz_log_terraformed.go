...
func (mg *Log) GetTerraformResourceType() string {
	return "cloudamqp_integration_log"
}

// GetConnectionDetailsMapping for this Log
func (tr *Log) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"access_key_id": "spec.forProvider.accessKeyIDSecretRef", "api_key": "spec.forProvider.apiKeySecretRef", "private_key": "spec.forProvider.privateKeySecretRef", "secret_access_key": "spec.forProvider.secretAccessKeySecretRef", "token": "spec.forProvider.tokenSecretRef"}
}
